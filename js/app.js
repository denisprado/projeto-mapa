...
var AppViewModel = function() {
  ...
  this.search = ko.computed(function() {
    var textToFilter = self.searchInput().toLowerCase();

    for (var y = 0; y < self.initialLocations().length; y++) {
      console.log(textToFilter);
      if (
        self.initialLocations()[y].title.toLowerCase().indexOf(textToFilter) > -1
      ) {
        // a função indexOf verifica se o que é digitado na caixa de texto é encontrado na array de localizações
        ...
        // esconde itens e amrcadores que não sejam encontrados no filtro
